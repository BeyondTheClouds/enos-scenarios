...
pip install -e file:///home/debian/tp2/enos#egg=enos
#+END_SRC
...
the [[file:../day1/SUBJECT.org::play-with-os][last part of the previous session]]. Horizon is available behind
the public IP of ~os_control_compute~.
#+END_NOTE

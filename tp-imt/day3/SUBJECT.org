...
* The QuakeJs Secret Project                                       :noexport:
...
#+INCLUDE: "~/prog/inria-perso/enos-scenarios/tp-imt/day3/lib/quakejs.sh"
...
: sudo iptables -t nat -A PREROUTING --dst $(hostname -I | cut -f1 -d ' ') -p tcp -m tcp --dport 27960 -j DNAT --to-destination 192.168.0.9:27960
: sudo iptables -t nat -A PREROUTING --dst $(hostname -I | cut -f1 -d ' ') -p udp -m udp --dport 27960 -j DNAT --to-destination 192.168.0.9:27960
